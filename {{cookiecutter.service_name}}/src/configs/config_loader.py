...
def load_all_settings():
    ...
    {% if cookiecutter.has_postgres == "yes" %}PostgresSettings.get_instance(){% endif %}
    {% if cookiecutter.has_redis == "yes" %}RedisSettings.get_instance(){% endif %}
    {% if cookiecutter.has_kafka == "yes" %}KafkaSettings.get_instance(){% endif %}
    {% if cookiecutter.has_s3 == "yes" %}S3Settings.get_instance(){% endif %}
    {% if cookiecutter.has_cratedb == "yes" %}CrateDBSettings.get_instance(){% endif %}
    {% if cookiecutter.auth_mode == "jwt" %}JWTSettings.get_instance(){% endif %}
    {% if cookiecutter.has_telemetry == "yes" %}TelemetrySettings.get_instance(){% endif %}
    {% if cookiecutter.parichay_client == "yes" %}ParichaySettings.get_instance(){% endif %}
    {% if cookiecutter.abhilekh_client == "yes" %}AbhilekhSettings.get_instance(){% endif %}
    {% if cookiecutter.kavach_client == "yes" %}KavachSettings.get_instance(){% endif %}
